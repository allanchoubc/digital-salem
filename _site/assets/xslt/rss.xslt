...
<xsl:template match="/rss">
	...
	<meta property="og:site_name" content="Digital Salem">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/feeling-responsive" class="icon-tree"> Digital Salem</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/">Digital Salem</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/getting-started/">About</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/design/">Projects</a>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/headers/">Digital Scholars Program</a>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/documentation/">Credits</a>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="Digital Salem – Telling Untold Stories of Salem, Massachusetts">
				<img src="http://localhost:4000/feeling-responsive/assets/img/logo.png" alt="Digital Salem – Telling Untold Stories of Salem, Massachusetts">
			</a>
